    ...
    <body>
        ...
        <div class="admin">
            <div class="table-responsive">
                <div class="text-center text-blue margin-big-bottom"><h2>船舶信息总览</h2></div>
                <form method="post" action="<%= request.getContextPath()%>/Admin/ShipManageServlet">
                ...
                <table class="table table-bordered">
                    <tr style="background-color: #eee ">
                        <td>船舶编号</td><td>船舶名称</td><td>船舶类型</td><td>船舶载重</td><td>船舶吨位</td><td>建造公司编号</td><td>所属公司编号</td><td>船舶建造时间</td><td>船舶当前价值</td><td>政府年检</td>  
                    </tr>
