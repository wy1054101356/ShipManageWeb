 ...
 * @author 思之声
 */
@WebServlet(name = "ConConOrderAddDoS", urlPatterns = {"/Admin/ConConOrderAddDoS"})
public class ConConOrderAddDoS extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        DaoFactory.GetConstructOrderDaoImp().AddConstructOrder(constructOrder);
