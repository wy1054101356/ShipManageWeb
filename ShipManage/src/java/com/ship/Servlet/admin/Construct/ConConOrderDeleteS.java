 ...
 * @author 思之声
 */
@WebServlet(name = "ConConOrderDeleteS", urlPatterns = {"/Admin/ConConOrderDeleteS"})
public class ConConOrderDeleteS extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        DaoFactory.GetConstructOrderDaoImp().DeleteConstructOrder(constructOrderId);
