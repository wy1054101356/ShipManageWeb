 ...
 * @author 思之声
 */
@WebServlet(name = "ConConOrderUpdateS", urlPatterns = {"/Admin/ConConOrderUpdateS"})
public class ConConOrderUpdateS extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("constructOrder", constructOrder);
        request.setAttribute("companys", companys);

        request.getRequestDispatcher("/admin/ConConOrderUpdate.jsp").forward(request, response);
    }
