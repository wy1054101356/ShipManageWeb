 ...
 * @author 思之声
 */
@WebServlet(name = "ConShipManageS", urlPatterns = {"/Admin/ConShipManageS"})
public class ConShipManageS extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (companyId != null && !"".equals(companyId)) {
            pagination.setUrl("ConShipManageS?companyId=" + companyId);
        ...
        request.getRequestDispatcher("/admin/ConShipManage.jsp").forward(request, response);
