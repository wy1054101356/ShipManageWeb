 ...
 * @author 思之声
 */
@WebServlet(name = "ProTraOrderUpdateS", urlPatterns = {"/Admin/ProTraOrderUpdateS"})
public class ProTraOrderUpdateS extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("transportOrder", transportOrder);

        request.getRequestDispatcher("/admin/ProTraOrderUpdate.jsp").forward(request, response);
