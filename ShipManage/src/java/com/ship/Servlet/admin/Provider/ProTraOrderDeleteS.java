 ...
 * @author wy105
 */
@WebServlet(name = "ProTraOrderDeleteS", urlPatterns = {"/Admin/ProTraOrderDeleteS"})
public class ProTraOrderDeleteS extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        DaoFactory.GetTransportOrderDaoImp().DeleteTransportOrder(transportOrderId);
