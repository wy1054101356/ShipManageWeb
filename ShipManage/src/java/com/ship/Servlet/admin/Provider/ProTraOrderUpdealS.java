 ...
 * @author 思之声
 */
@WebServlet(name = "ProTraOrderUpdealS", urlPatterns = {"/Admin/ProTraOrderUpdealS"})
public class ProTraOrderUpdealS extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (deal != null && !deal.equals("")) {
            DaoFactory.GetTransportOrderDaoImp().ChangeDeal(transportOrderId);
        }
