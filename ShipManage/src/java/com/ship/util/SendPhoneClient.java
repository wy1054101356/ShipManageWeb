...
public class SendPhoneClient {
    ...
    private static SendPhoneClient instance = null;

    private SendPhoneClient() {
    }

    public static SendPhoneClient getInstance() {
        if (instance == null) {
            instance = new SendPhoneClient();
        }
        return instance;
    }
